...
namespace TodoApi.Pages.Configurations.Products
{
    public class Edit : PageModel
    {
        ...
        {
            var productModel = context.ProductModel?.Include(p => p.Category).FirstOrDefault(p => p.Id == id);
        ...
        public IActionResult OnPost()
        {
            ...
            var category = context.CategoryModel?.Where(c => c.Id == int.Parse(SelectedCategory!)).FirstOrDefault();
